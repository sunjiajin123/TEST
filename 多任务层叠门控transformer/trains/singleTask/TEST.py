...
class TEST():
    ...
    def do_train(self, model, dataloader):
        optimizer = optim.Adam(list(model.parameters()), lr=self.args.learning_rate)
        # initilize results
        ...
        while True:
            ...
            with tqdm(dataloader['train']) as td:
                for batch_data in td:
                    ...
                    labels = batch_data['labels']['T'].to(self.args.device)
            ...
            logger.info("TRAIN-(%s) (%d/%d/%d)>> loss: %.4f %s" % (self.args.modelName, \
                                                                   ...
                                                                   train_loss, dict_to_str(train_results)))
            # validation
