...
class RCM_2(nn.Module):

    def __init__(self, args):
        super(RCM_2, self).__init__()
    ...
    def forward(self, text_x, audio_x, video_x):
        ...
        f=torch.cat((t,vision_output_1,fuse_2[:,0,:]),dim=1)
        fuse_output=self.linear_f_3(self.linear_f_2(self.linear_f_1(f)))

        ##########
        # fuse_output=self.linear_fuse_3(self.linear_fuse_2(self.linear_fuse_1(fuse_2[:,0,:])))
